...
urlpatterns = [
    ...
    path('sites/atualizar/<int:pk>/', views.site_update, name='site-update'),  # Atualizar site específico
    ...
    path('usuarios/atualizar/<int:pk>/', views.usuario_update, name='usuario-update'),  # Atualizar usuário específico
