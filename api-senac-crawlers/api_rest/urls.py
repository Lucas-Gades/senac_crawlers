...
urlpatterns = [
    ...
    path('editais/deletar/<int:pk>/', views.edital_list, name='edital-detail'),  # Detalhar e deletar edital específico
    ...
    path('sites/deletar/<int:pk>/', views.site_list, name='site-detail'),  # Detalhar e deletar site específico
    ...
    path('usuarios/deletar/<int:pk>/', views.usuario_list, name='usuario-detail'),  # Detalhar e deletar usuário específico
